...
public class JobPositionController {
    ...
    private LinkedListStack jobPositionList;
    ...
    public void initialize() {
        ...
        if (jobPositionList == null) {
            this.jobPositionList = new LinkedListStack();
    ...
    public ObservableList<JobPositionWrapper> convertToObservableList(LinkedListStack list) {
    ...
    public void addOnAction(ActionEvent actionEvent) {
        util.FXUtility.loadPage("ucr.lab6.HelloApplication", "addJob-view.fxml", mainPain);
    }
    ...
    private void sortByName(LinkedListStack list) throws StackException {
        if(list.isEmpty())
    ...
    private void sortByHourlyWage(LinkedListStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Doubly Linked List is empty");
