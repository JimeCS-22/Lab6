...
public class addStaffController {
    ...
    private void loadEmployees() {
        ...
        ArraysStack employeeList = util.Utility.getEmployeeList();
    ...
    private void loadJobs() {
        ...
        LinkedListStack jobList = util.Utility.getJobPositionList();
    ...
    public void addOnAction(ActionEvent actionEvent) {
        if (validateFields()) {
            try {
                ...
                LinkedListStack staffList = util.Utility.getStaffingList();
                if (staffList == null) {
                    staffList = new LinkedListStack();
                }
