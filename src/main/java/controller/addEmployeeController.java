...
public class addEmployeeController {
    ...
    public void addOnAction(ActionEvent actionEvent) {
        ...
        ArraysStack list = util.Utility.getEmployeeList(); //Se toma la lista ya existente y se le agrega el nuevo empleado
    ...
    public void exitView(ActionEvent actionEvent) {
        util.FXUtility.loadPage("ucr.lab6.HelloApplication", "employees-view.fxml", mainPain);
    }
