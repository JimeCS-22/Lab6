...
public class EmployeesController {
    ...
    private ArraysStack employeesList;
    ...
    public void initialize() {
        ...
        if (employeesList == null) {
            this.employeesList = new ArraysStack();
    ...
    public ObservableList<Employee> convertToObservableList(ArraysStack list) {
    ...
    public void addOnAction(ActionEvent actionEvent) {
        util.FXUtility.loadPage("ucr.lab6.HelloApplication", "addEmployee-view.fxml", mainPain);
    }
    ...
    @FXML
    public void refreshOnAction(ActionEvent actionEvent) throws StackException {
    ...
    public void sortByID(ArraysStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Linked List is empty");
    ...
    public void sortByName(ArraysStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Linked List is empty");
