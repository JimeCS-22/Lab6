...
public class StaffingController {
    ...
    private LinkedListStack staffingList;
    ...
    public void initialize() {
        ...
        LinkedListStack existingList = util.Utility.getStaffingList();
        if (existingList != null) {
            this.staffingList = existingList;
        } else {
            this.staffingList = new LinkedListStack();
    ...
    private ObservableList<Staffing> convertToObservableList(LinkedListStack list) {
    ...
    public void addOnAction(ActionEvent actionEvent) {
        util.FXUtility.loadPage("ucr.lab6.HelloApplication", "addStaff-view.fxml", mainPain);
    }
    ...
    private void sortByEmployeeId(LinkedListStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Doubly Linked List is empty");
    ...
    private void sortByEmployeeName(LinkedListStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Doubly Linked List is empty");
    ...
    private void sortByJobPosition(LinkedListStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Doubly Linked List is empty");
    ...
    private void sortByAssignationType(LinkedListStack list) throws StackException {
        if(list.isEmpty())
            throw new StackException("Circular Doubly Linked List is empty");
