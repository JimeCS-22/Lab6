...
public interface Queues {
    ...
    public int size() throws QueueException; // devuelve el número de elementos en la cola
    public void clear(); //elimina / inicializa la Cola
    public boolean isEmpty(); // true si la Cola está vacía
    public int indexOf(Object element) throws QueueException, StackException; //devuelve la posicion de un elemento en la Cola
    ...
    public boolean contains(Object element) throws QueueException, StackException; //true si el elemento fue encolado
